...
[![Skills](https://img.shields.io/badge/116%2B-AI%20Skill%20Packs-a78bfa?style=for-the-badge&labelColor=020617)](#what-you-get)
...
<table>
  <tr>
    <td width="33%" align="center">
      ...
      <sub>116+ reusable skills via <a href="https://github.com/ulises-jeremias/agent-toolkit">agent-toolkit</a> — ClickUp, Figma, GitHub, GitLab, Slack, dbt, Snowflake, Playwright, and more (<code>agent-toolkit inventory</code>)<br/><em>Jira and Confluence are bundled in agent-toolkit and installed with the canonical Toolkit catalog</em></sub>
    </td>
    <td width="33%" align="center">
      <br>
      <b>🤖 AI Agents</b><br>
...
Add 116+ AI skills to your existing setup — powered by **[agent-toolkit](https://github.com/ulises-jeremias/agent-toolkit)**:
...
| **L1.5** | [agent-toolkit](https://github.com/ulises-jeremias/agent-toolkit) | **Sole** capability distribution — 116+ skills, agents, loops, profiles, MCP, prompts, packs (verify with `agent-toolkit inventory`) |
