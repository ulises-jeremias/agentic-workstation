---
name: dots-workstation-planning
description: >-
...
1. Apply **`dots-workstation-output-handshake`** before producing any final planning artifact: ask where it should live and confirm human review.
...
3. If a work item is being created or refined, pair this with **`dots-workstation-work-item`** and the relevant atomic skill.
...
- `dots-workstation-work-item` - work item hierarchy and creation
