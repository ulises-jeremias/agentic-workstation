---
name: dots-workstation-project-assessment-evidence
description: >-
...
5. Do not score indicators. Return the evidence map to **`dots-workstation-project-assessment`**, **`dots-workstation-technical-unit-assessment`**, or **`dots-workstation-management-unit-assessment`**.
...
- `dots-workstation-project-assessment` - assessment router
- `dots-workstation-technical-unit-assessment` - technical scoring
- `dots-workstation-management-unit-assessment` - management scoring
- `dots-workstation-output-handshake` - destination and review for final artifacts
