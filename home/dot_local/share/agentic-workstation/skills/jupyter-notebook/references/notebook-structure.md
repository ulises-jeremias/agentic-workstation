...
Prefer scaffolding from the bundled templates or `new_notebook.py` (for example, `~/.local/share/agentic-workstation/skills/jupyter-notebook/scripts/new_notebook.py`, or the `dots-newnotebook` wrapper) instead of hand-authoring raw notebook JSON.
