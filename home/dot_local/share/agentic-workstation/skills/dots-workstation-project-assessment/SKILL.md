---
name: dots-workstation-project-assessment
description: >-
  WHAT - Interactive project assessment router: define assessment scope and units,
  collect evidence through dots-workstation-project-assessment-evidence, then delegate to
...
1. Apply **`dots-workstation-output-handshake`** before producing any final assessment report, scorecard, action plan, or executive summary: ask where the artifact should live and confirm human review.
2. Apply **`dots-workstation-project-assessment-evidence`** before scoring. Evidence may live in repositories, boards, docs, spreadsheets, dashboards, incidents, PRs, meetings, interviews, Slack, emails, or any other project system. Ask the user where to find each source.
...
- `dots-workstation-project-assessment-evidence` - evidence map and source-by-source intake
- `dots-workstation-technical-unit-assessment` - technical unit indicators and template
- `dots-workstation-management-unit-assessment` - management unit indicators and template
- `dots-workstation-output-handshake` - destination and human review
- `dots-workstation-assistant` - repository discovery
