---
name: dots-workstation-management-unit-assessment
description: >-
...
1. Apply **`dots-workstation-output-handshake`** before final scorecards or reports.
...
- `dots-workstation-project-assessment-evidence` - evidence map
- `dots-workstation-project-assessment` - multi-unit router
- `dots-workstation-planning` - planning and estimation evidence
- `dots-workstation-development-workflow` - workflow, DoR, DoD, and validation evidence
- `dots-workstation-meeting-minutes`, `dots-workstation-decision-log`, `dots-workstation-agreement`, `dots-workstation-incident` - common management evidence artifacts
