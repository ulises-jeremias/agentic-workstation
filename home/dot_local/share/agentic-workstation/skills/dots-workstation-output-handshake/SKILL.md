---
name: dots-workstation-output-handshake
description: >-
...
3. Then proceed with the relevant skill (**`dots-workstation-prd`**, **`dots-workstation-trd`**, **`dots-workstation-adr`**, **`dots-workstation-work-item`**, **`dots-workstation-planning`**, **`dots-workstation-development-workflow`**, **`dots-workstation-project-assessment`**, **`dots-workstation-project-assessment-evidence`**, **`dots-workstation-technical-unit-assessment`**, **`dots-workstation-management-unit-assessment`**, **`dots-workstation-meeting-minutes`**, **`dots-workstation-decision-log`**, **`dots-workstation-agreement`**, **`dots-workstation-incident`**, **`dots-workstation-spike`**, **`dots-workstation-pr-fallback`** + forge workflow, etc.).
...
- `dots-workstation-assistant` — discover existing `docs/`, PR templates, `AGENTS.md`
