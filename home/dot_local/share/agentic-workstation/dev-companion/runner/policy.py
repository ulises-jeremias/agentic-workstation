"""LLM execution policy for the agentic-workstation dev-companion runner.
...
2. Optional JSON config file at ``~/.config/agentic-workstation/devcompanion-llm.json``
...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "agentic-workstation" / "devcompanion-llm.json"
