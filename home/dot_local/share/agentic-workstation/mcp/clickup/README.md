...
> The workstation installs the global skill at `~/.local/share/agentic-workstation/skills/clickup-cli/SKILL.md`.
...
The `clickup-cli` skill is deployed by chezmoi at `~/.local/share/agentic-workstation/skills/clickup-cli/` and linked globally for Claude Code, Cursor, Copilot, OpenCode, and pi.
