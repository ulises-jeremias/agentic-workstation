...
Store them in `~/.config/agentic-workstation/env.d/figma.env` (covered by `dots-loadenv`):
...
- `~/.local/share/agentic-workstation/skills/figma/SKILL.md` and the `figma-*` skill
  family.
