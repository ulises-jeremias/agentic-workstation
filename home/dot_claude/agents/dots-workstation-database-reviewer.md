...
description: "agentic-workstation Database Reviewer — PostgreSQL and database specialist. Use for schema design, query optimization, migration review, index analysis, and ORM usage questions."
