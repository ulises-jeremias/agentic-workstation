...
description: "agentic-workstation Build Error Resolver — TypeScript and build error specialist. Use proactively when encountering compilation errors, type errors, lint failures, or CI pipeline failures."
---
