---
name: dots-workstation-client-workflow-bootstrap
description: "agentic-workstation client workflow bootstrap specialist. Use when onboarding a new client project or updating an existing delivery workflow skill pair. Conducts a structured interview and generates dots-workstation-<client>-workflow + dots-workstation-<client>-dev-companion skills, then opens a draft PR to agentic-workstation."
...
delivery workflow skill pair (`dots-workstation-<client>-workflow` + `dots-workstation-<client>-dev-companion`) and open
...
Full question details are in `dots-workstation-workflow-client-bootstrap/questions.yaml`.
...
- `skills/dots-workstation-<slug>-workflow/SKILL.md` — delivery phases adapted to client lifecycle
- `skills/dots-workstation-<slug>-workflow/reference.md` — repos, URLs, ticket lifecycle, validation
- `skills/dots-workstation-<slug>-workflow/skill.json`
- `skills/dots-workstation-<slug>-dev-companion/SKILL.md`
- `skills/dots-workstation-<slug>-dev-companion/skill.json`
- Update `skills/skill-catalog.yaml` (two new entries)
- `dot_claude/agents/dots-workstation-<slug>-delivery.md`
- `dot_config/opencode/agents/dots-workstation-<slug>-delivery.md`

## Commit and PR

After the user approves the generated files:
1. `git add` all new/modified files
2. Commit: `feat(skills): add dots-workstation-<slug>-workflow and dev-companion skill pair`
