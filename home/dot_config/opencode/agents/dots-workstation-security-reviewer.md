---
description: "agentic-workstation Security Reviewer — vulnerability detection specialist. Use proactively after implementing authentication, data handling, API endpoints, or any user-facing functionality."
mode: subagent
color: error
---
