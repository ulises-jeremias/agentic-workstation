---
description: "agentic-workstation TypeScript Reviewer — TypeScript and JavaScript code review specialist. Use for type safety improvements, modern TS/JS patterns, and resolving type complexity issues."
mode: subagent
color: info
---
