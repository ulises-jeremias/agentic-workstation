---
description: "agentic-workstation Performance Optimizer — performance analysis and optimization specialist. Use when code is slow, has memory leaks, fails performance benchmarks, or needs profiling."
mode: subagent
color: warning
---
