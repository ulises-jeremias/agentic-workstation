...
MIGRATE_FROM="ulises-jeremias/dots-ai"
...
declare -A DIR_MIGRATIONS=(
  ["${HOME}/.dots-ai"]="${HOME}/.agentic-workstation"
  ["${HOME}/.local/share/dots-ai"]="${HOME}/.local/share/agentic-workstation"
  ["${HOME}/.local/lib/dots-ai"]="${HOME}/.local/lib/agentic-workstation"
  ["${HOME}/.config/dots-ai"]="${HOME}/.config/agentic-workstation"
)

CHEZMOI_CONFIG_OLD="${HOME}/.config/chezmoi/dots-ai.toml"
...
main() {
  printf '\n\033[1m=== dots-ai -> agentic-workstation migration ===\033[0m\n\n'
  printf '\033[1m[1/3] Updating remotes\033[0m\n'
  update_remote "${HOME}/.dots-ai" "~/.dots-ai"
  update_remote "${HOME}/.ai-workspace/repos/github.com/ulises-jeremias/dots-ai" "repos/dots-ai"
