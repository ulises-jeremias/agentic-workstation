...
| **L1.5** | [agent-toolkit](https://github.com/ulises-jeremias/agent-toolkit) | Capability distribution — 60 skills, loops, profiles, MCP |
...
agent-toolkit inventory                        # list all 60 skills
